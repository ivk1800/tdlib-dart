...
/// getChatBoostStatus and canBoostChat to get the current boost status and
/// check whether the chat can be boosted. If the user wants to boost the chat
/// and the chat can be boosted, then call boostChat
@immutable
