...
/// menu, then show a disclaimer about Mini Apps being a third-party apps, ask
/// the user to accept their Terms of service and confirm adding the bot to
/// side and attachment menu. If the user accept the terms and confirms
/// adding, then use toggleBotIsAddedToAttachmentMenu to add the bot. If the
/// attachment menu bot can't be used in the opened chat, show an error to the
/// user. If the bot is added to attachment menu and can be used in the chat,
