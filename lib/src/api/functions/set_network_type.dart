...
/// in switching between different networks, so it should be called whenever
/// the network is changed, even if the network type remains the same..
/// Network type is used to check whether the library can use the network at
/// all and also for collecting detailed network data usage statistics
/// Returns [Ok]
